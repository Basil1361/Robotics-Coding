...
# Start PWM signals for 5 seconds
start_time = running_time()  # Get the current time in milliseconds
while running_time() - start_time < 5000:  # Run for 5 seconds
    forward()
    sleep(1000)
    left()
    sleep(1000)
    ...
    sleep(500)
# Stop all signals after 5 seconds
pwm.set_all_pwm(0, 0)
